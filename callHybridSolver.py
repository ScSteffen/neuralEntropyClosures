...
def main():
    ...
    parser.add_option("-x", "--gridsize", dest="gridsize", default=80,
                      help="number of grid cells in one dimension", metavar="GRIDSIZE")
    ...
    options.gridsize = int(options.gridsize)
    ...
    if options.spatial_dimension == 1:
        ...
        solver.solve(max_iter=100000, t_end=0.2)
