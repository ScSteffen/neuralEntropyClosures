...
fnn = FastICNN(2, 1, [10, 10, 10, 10], tanh)
...
res = sci_train(fnn, (X, Y); maxiters=200)
res = sci_train(fnn, (X, Y), res.u, ADAM(); maxiters=10000)
res = sci_train(fnn, (X, Y), res.u, LBFGS(); maxiters=10000)
