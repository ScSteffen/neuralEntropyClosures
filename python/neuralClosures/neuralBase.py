...
class neuralBase:
    ...
    def loadTrainingData(self):
        ...
        self.trainingData = []
        if (self.spatialDim == 1):
            filename = "data/1_stage/1D/Monomial_M" + str(self.polyDegree) + "_D" + str(self.spatialDim) + ".csv"
        else:
            filename = "data/1_stage/Monomial_M" + str(self.polyDegree) + ".csv"
